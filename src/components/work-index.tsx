...
export function WorkIndex({
  ...
  // Real data for the eyebrow: how many projects sit under each pillar.
            ...
            >
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
                <span className={EYEBROW}>
                  {dictionary.pillars[project.pillar]} · {formatMonth(project.started, lang)}
                </span>
              ...
              <h3 className="mt-3 max-w-[28ch] text-xl font-medium tracking-tight transition-colors group-hover:text-primary">
                {project.title[lang]}
              </h3>

              <p className={cn("mt-2 max-w-[62ch] text-sm", TEXT.subtle)}>
